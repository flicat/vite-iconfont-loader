import { globSync as od } from "glob";
import { readFileSync as ud } from "fs";
import { optimize as ld } from "svgo";
/**
...
const cd = Object.freeze({}), Vi = () => {
}, Os = () => !1, hc = (t) => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && // uppercase letter
(t.charCodeAt(2) > 122 || t.charCodeAt(2) < 97), tt = Object.assign, hd = Object.prototype.hasOwnProperty, pd = (t, s) => hd.call(t, s), Ae = Array.isArray, fd = (t) => oa(t) === "[object Map]", dd = (t) => oa(t) === "[object Set]", md = (t) => typeof t == "function", ne = (t) => typeof t == "string", vt = (t) => typeof t == "symbol", Ct = (t) => t !== null && typeof t == "object", pc = Object.prototype.toString, oa = (t) => pc.call(t), fc = (t) => oa(t) === "[object Object]", xu = /* @__PURE__ */ Oe(
  ...
  (t) => t.replace(yd, (s, r) => r ? r.toUpperCase() : "")
), gd = /\B([A-Z])/g, bd = Hr(
  (t) => t.replace(gd, "-$1").toLowerCase()
), Ws = Hr((t) => t.charAt(0).toUpperCase() + t.slice(1)), xd = Hr(
  (t) => t ? `on${Ws(t)}` : ""
), Sd = /^[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*$/;
function Su(t) {
  return Sd.test(t) ? `__props.${t}` : `__props[${JSON.stringify(t)}]`;
}
const Sr = {
  1: "TEXT",
  2: "CLASS",
  ...
  2: "DYNAMIC",
  3: "FORWARDED"
}, Pd = "Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error,Symbol", mc = /* @__PURE__ */ Oe(Pd), Eu = 2;
...
function bc(t) {
  const s = {};
  return t.replace(wd, "").split(Td).forEach((r) => {
    if (r) {
      const o = r.split(Ad);
...
const Pc = (t) => !!(t && t.__v_isRef === !0), zr = (t) => ne(t) ? t : t == null ? "" : Ae(t) || Ct(t) && (t.toString === pc || !md(t.toString)) ? Pc(t) ? zr(t.value) : JSON.stringify(t, Tc, 2) : String(t), Tc = (t, s) => Pc(s) ? Tc(t, s.value) : fd(s) ? {
...
function Jd(t) {
  var s;
  return t >= 55296 && t <= 57343 || t > 1114111 ? 65533 : (s = Kd.get(t)) !== null && s !== void 0 ? s : t;
}
var ve;
(function(t) {
...
class kc {
  ...
  stateNumericStart(s, r) {
    return r >= s.length ? -1 : (s.charCodeAt(r) | Yd) === ve.LOWER_X ? (this.state = Te.NumericHex, this.consumed += 1, this.stateNumericHex(s, r + 1)) : (this.state = Te.NumericDecimal, this.stateNumericDecimal(s, r));
  }
  ...
  emitNumericEntity(s, r) {
    ...
    if (s === ve.SEMI)
      ...
      return 0;
    return this.emitCodePoint(Jd(this.result), this.consumed), this.errors && (s !== ve.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(s, r) {
    ...
    for (; r < s.length; r++, this.excess++) {
      ...
      if (this.treeIndex = t0(o, u, this.treeIndex + Math.max(1, c), l), this.treeIndex < 0)
        ...
        e0(l)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Mc(t, s, r, ...o) {
  if (Vn(t, s) === "suppress-warning")
    return;
  const { message: c, link: l } = a0[t], h = `(deprecation ${t}) ${typeof c == "function" ? c(...o) : c}${l ? `
...
- Did you mean \`import { "${S}" as foo }\`?`,
  ...
  function nt(S) {
    return S < 65 ? S === 36 : S <= 90 ? !0 : S < 97 ? S === 95 : S <= 122 ? !0 : S <= 65535 ? S >= 170 && Yp.test(String.fromCharCode(S)) : _i(S, So);
  }
  function Yt(S) {
    return S < 48 ? S === 36 : S < 58 ? !0 : S < 65 ? !1 : S <= 90 ? !0 : S < 97 ? S === 95 : S <= 122 ? !0 : S <= 65535 ? S >= 170 && Qp.test(String.fromCharCode(S)) : _i(S, So) || _i(S, Zp);
  }
  const Oi = {
    keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"],
    strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"],
    strictBind: ["eval", "arguments"]
  }, ef = new Set(Oi.keyword), tf = new Set(Oi.strict), sf = new Set(Oi.strictBind);
  function Eo(S, i) {
    return i && S === "await" || S === "enum";
  }
  function Po(S, i) {
    return Eo(S, i) || tf.has(S);
  }
  function To(S) {
    return sf.has(S);
  }
  ...
  const af = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
  function of(S) {
    return af.has(S);
  }
  class ki {
  ...
  const cf = /* @__PURE__ */ new Set(["_", "any", "bool", "boolean", "empty", "extends", "false", "interface", "mixed", "null", "number", "static", "string", "true", "typeof", "void"]), Y = P`flow`({
  ...
  const df = /\*?\s*@((?:no)?flow)\b/;
  var mf = (S) => class extends S {
    constructor(...e) {
    ...
    flowParseDeclareModule(e) {
      ...
      let f = null, E = !1;
      return a.forEach((A) => {
        hf(A) ? (f === "CommonJS" && this.raise(Y.AmbiguousDeclareModuleKind, A), f = "ES") : A.type === "DeclareModuleExports" && (E && this.raise(Y.DuplicateDeclareModuleExports, A), f === "ES" && this.raise(Y.AmbiguousDeclareModuleKind, A), f = "CommonJS", E = !0);
    ...
    checkReservedType(e, n, a) {
      cf.has(e) && this.raise(a ? Y.AssignReservedType : Y.UnexpectedReservedType, n, {
        reservedType: e
      });
    }
    ...
    getArrowLikeExpressions(e, n) {
      ...
      return n ? (f.forEach((E) => this.finishArrowValidation(E)), [f, []]) : ff(f, (E) => E.params.every((A) => this.isAssignable(A, !0)));
    }
    ...
    getTokenFromCode(e) {
      ...
      e === 123 && n === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? n === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : nf(e, n, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
    }
    isAssignable(e, n) {
...
`) : a = String.fromCharCode(n), ++this.state.curLine, this.state.lineStart = this.state.pos, a;
    ...
    jsxReadEntity() {
      ...
      if (this.codePointAtPos(this.state.pos) === 35) {
        ...
        for (; n++ < 10 && this.state.pos < this.length && !(a = this.codePointAtPos(this.state.pos) === 59); )
          ++this.state.pos;
        if (a) {
          const f = this.input.slice(e, this.state.pos), E = yf[f];
          if (++this.state.pos, E)
            return E;
        }
      }
  ...
  class Ef extends Li {
    ...
    createScope(i) {
      return this.importsStack.push(/* @__PURE__ */ new Set()), new Sf(i);
    }
    enter(i) {
  ...
  class wf extends Tf {
    ...
    finalizeComment(i) {
      ...
      if (i.leadingNode !== null || i.trailingNode !== null)
        i.leadingNode !== null && Co(i.leadingNode, e), i.trailingNode !== null && Af(i.trailingNode, e);
      else {
        const {
          containingNode: n,
          start: a
  ...
  function No(S, i, e, n, a, f) {
    ...
    for (; ; ) {
      ...
      if (H === 92) {
        _ += i.slice(B, e);
        const G = If(i, e, n, a, S === "template", f);
        G.ch === null && !k ? k = {
          pos: e,
          lineStart: n,
          curLine: a
...
`);
  ...
  function _o(S, i, e, n, a, f, E, A, w, _) {
    ...
    for (let se = 0, be = f ?? 1 / 0; se < be; ++se) {
      ...
      if (re >= 97 ? ce = re - 97 + 10 : re >= 65 ? ce = re - 65 + 10 : vf(re) ? ce = re - 48 : ce = 1 / 0, ce >= a) {
        if (ce <= 9 && _)
          return {
            n: null,
            pos: i
  ...
  const Nf = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]);
  class gt {
    constructor(i) {
  ...
  class Ff extends _f {
    ...
    initializeScopes(i = this.options.sourceType === "module") {
      ...
      this.prodParam = new Pf();
      const w = this.classScope;
      this.classScope = new kf(this);
      const _ = this.expressionScope;
      return this.expressionScope = new Lf(this), () => {
  ...
  var qf = (S) => class extends S {
    ...
    tsParseModifiers({
      ...
      for (; ; ) {
        ...
        Do(k) ? E.accessibility ? this.raise(K.DuplicateAccessibilityModifier, _, {
          modifier: k
        }) : (A(_, k, k, "override"), A(_, k, k, "static"), A(_, k, k, "readonly"), E.accessibility = k) : jf(k) ? (E[k] && this.raise(K.DuplicateModifier, _, {
          modifier: k
    ...
    tsParseDelimitedList(e, n, a) {
      return $f(this.tsParseDelimitedListWorker(e, n, !0, a));
    }
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        default: {
          ...
          if (ie(e) || e === 88 || e === 84) {
            const n = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : Vf(this.state.value);
    ...
    tsParseTypeOperatorOrHigher() {
      return Gp(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(115) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
    }
    ...
    parseVarStatement(e, n, a = !1) {
      ...
      for (const {
        ...
        w && (n !== "const" || A.typeAnnotation ? this.raise(K.InitializerNotAllowedInAmbientContext, w) : zf(w, this.hasPlugin("estree")) || this.raise(K.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, w));
      return E;
    }
  ...
  function zf(S, i) {
    ...
    if (i) {
      ...
      return !0;
    return !!(Fo(S, i) || Xf(S, i) || n === "TemplateLiteral" && S.expressions.length === 0 || Hf(S));
  }
  function Fo(S, i) {
  ...
  class Yf extends Uf {
    ...
    parseMaybeAssign(i, e) {
      ...
      if (e && (A = e.call(this, A, n)), qp(this.state.type)) {
    ...
    parseExprOp(i, e, n) {
      ...
      const a = this.state.type;
      if (zp(a) && (this.prodParam.hasIn || !this.match(58))) {
        let f = ir(a);
        if (f > n) {
          if (a === 39) {
    ...
    parseExprOpBaseRightExpr(i, e) {
      const n = this.state.startLoc;
      return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), n, Jp(i) ? e - 1 : e);
    }
    parseHackPipeBody() {
      var i;
      const {
    ...
    parseUpdate(i, e, n) {
      ...
      for (; Xp(this.state.type) && !this.canInsertSemicolon(); ) {
    ...
    parseCoverCallAndAsyncArrowHead(i, e, n, a) {
      ...
      w && (this.expressionScope.enter(Df()), E = new cr()), _ && (A.optional = a), a ? A.arguments = this.parseCallExpressionArguments(11) : A.arguments = this.parseCallExpressionArguments(11, i.type !== "Super", A, E);
    ...
    parseParenAndDistinguishExpression(i) {
      const e = this.state.startLoc;
      let n;
      this.next(), this.expressionScope.enter(Rf());
...
`),
  ...
  class td extends Yf {
    parseTopLevel(i, e) {
      return i.program = this.parseProgram(e), i.comments = this.comments, this.optionFlags & 256 && (i.tokens = ed(this.tokens, this.input, this.startIndex)), this.finishNode(i, "File");
    }
    ...
    parseSwitchStatement(i) {
      ...
      const e = i.cases = [];
      this.expect(5), this.state.labels.push(Qf), this.scope.enter(0);
      let n;
    ...
    parseLabeledStatement(i, e, n, a) {
      ...
      const f = Hp(this.state.type) ? 1 : this.match(71) ? 2 : null;
    ...
    parseFunctionParams(i, e) {
      this.expect(10), this.expressionScope.enter(Mf()), i.params = this.parseBindingList(11, 41, 2 | (e ? 4 : 0)), this.expressionScope.exit();
    }
    ...
    parseModuleExportName() {
      if (this.match(134)) {
        const i = this.parseStringLiteral(this.state.value), e = Zf.exec(i.value);
  ...
  return es.parse = sd, es.parseExpression = rd, es.tokTypes = nd, es;
}
var Ut = /* @__PURE__ */ c0();
class h0 {
  constructor() {
...
function f0(t, { enter: s, leave: r }) {
  return new p0(s, r).visit(t, null);
}
...
const m0 = /^\d|[^\$\w\xA0-\uFFFF]/, pt = (t) => !m0.test(t), y0 = /[A-Za-z_$\xA0-\uFFFF]/, g0 = /[\.\?\w$\xA0-\uFFFF]/, b0 = /\s+[.[]\s*|\s*[.[]\s+/g, ni = (t) => t.type === 4 ? t.content : t.loc.source, x0 = (t) => {
  const s = ni(t).trim().replace(b0, (h) => h.trim());
...
}, Ta = Xc, S0 = /^\s*(async\s*)?(\([^)]*?\)|[\w$_]+)\s*(:[^=]+)?=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/, E0 = (t) => S0.test(ni(t)), Wc = (t, s) => {
  try {
    let r = t.ast || Ut.parseExpression(ni(t), {
      plugins: s.expressionPlugins ? [...s.expressionPlugins, "typescript"] : ["typescript"]
    });
...
const P0 = /* @__PURE__ */ new Set([cs, ys]);
function Kc(t, s = []) {
  if (t && !ne(t) && t.type === 14) {
    const r = t.callee;
    if (!ne(r) && P0.has(r))
      ...
      if (Rt(ue.loc, s), t !== 0)
        if (ue.type === 6)
          ...
          ue.name === "for" ? r = 3 : ue.name === "slot" ? r = 1 : ue.name === "on" && Xe.includes(";") && (r = 2), ue.exp = Tr(
            ...
            0,
            r
          ), ue.name === "for" && (ue.forParseResult = A0(ue.exp));
        }
...
function Pr(t, s, r = !1) {
  r ? Rt(t.loc, Zc(s, 60)) : Rt(t.loc, w0(s, 62) + 1), fe.inSFCRoot && (t.children.length ? t.innerLoc.end = tt({}, t.children[t.children.length - 1].loc.end) : t.innerLoc.end = tt({}, t.innerLoc.start), t.innerLoc.source = ke(
    t.innerLoc.start.offset,
    t.innerLoc.end.offset
  ));
  const { tag: o, ns: u, children: c } = t;
  if (Pt || (o === "slot" ? t.tagType = 2 : C0(t) ? t.tagType = 3 : I0(t) && (t.tagType = 1)), fe.inRCDATA || (t.children = eh(c)), u === 0 && he.isIgnoreNewlineTag(o)) {
    const l = c[0];
...
function C0({ tag: t, props: s }) {
  if (t === "template") {
    for (let r = 0; r < s.length; r++)
      if (s[r].type === 7 && v0.has(s[r].name))
        return !0;
  }
  return !1;
}
function I0({ tag: t, props: s }) {
  if (he.isCustomElement(t))
    return !1;
  if (t === "component" || N0(t.charCodeAt(0)) || Pa(t) || he.isBuiltInComponent && he.isBuiltInComponent(t) || he.isNativeTag && !he.isNativeTag(t))
    return !0;
  for (let r = 0; r < s.length; r++) {
    const o = s[r];
...
function eh(t, s) {
  ...
  for (let u = 0; u < t.length; u++) {
    ...
    if (c.type === 2)
      if (va)
        c.content = c.content.replace(_0, `
`);
      else if (O0(c.content)) {
        const l = t[u - 1] && t[u - 1].type, h = t[u + 1] && t[u + 1].type;
        !l || !h || r && (l === 3 && (h === 3 || h === 1) || l === 1 && (h === 3 || h === 1 && k0(c.content))) ? (o = !0, t[u] = null) : c.content = " ";
...
function rh(t, s) {
  if (t.type === 14 && !ne(t.callee) && F0.has(t.callee)) {
...
function Ca(t, s) {
  const r = ui(t, s);
  gs(t, r), s.hoistStatic && D0(t, r), s.ssr || B0(t, r), t.helpers = /* @__PURE__ */ new Set([...r.helpers.keys()]), t.components = [...r.components], t.directives = [...r.directives], t.imports = r.imports, t.hoists = r.hoists, t.temps = r.temps, t.cached = r.cached, t.transformed = !0;
}
function B0(t, s) {
...
function ah() {
  if (_u) return dr;
  _u = 1;
  var t = /* @__PURE__ */ $0(), s = 5, r = 1 << s, o = r - 1, u = r;
  function c(h) {
...
function uh() {
  if (Mu) return zi;
  Mu = 1;
  var t = /* @__PURE__ */ ah(), s = /* @__PURE__ */ er(), r = oh().ArraySet, o = V0().MappingList;
  function u(c) {
...
function H0() {
  if (Fu) return Ns;
  Fu = 1;
  var t = /* @__PURE__ */ er(), s = /* @__PURE__ */ j0(), r = oh().ArraySet, o = /* @__PURE__ */ ah(), u = q0().quickSort;
  function c(b, g) {
    var x = b;
...
var Uu;
function li() {
  return Uu || (Uu = 1, Is.SourceMapGenerator = uh().SourceMapGenerator, Is.SourceMapConsumer = H0().SourceMapConsumer, Is.SourceNode = z0().SourceNode), Is;
}
var wr = /* @__PURE__ */ li();
...
`,
    -1
    /* End */
  ), t.imports.length && (G0(t.imports, s), c()), lh(t.hoists, s), c(), o || u("export ");
}
...
function hi(t, s) {
  const r = t.length > 3 || t.some((o) => Ae(o) || !K0(o));
...
function rm(t, s) {
  ...
  for (let p = 0; p < l.length; p++) {
    ...
    Q0(m, s), r(": "), me(d, s), p < l.length - 1 && (r(","), c());
  }
  h && u(), r(h ? "}" : " }");
}
function im(t, s) {
...
function hm({ returns: t }, s) {
  s.push("return "), Ae(t) ? hi(t, s) : me(t, s);
}
const pm = /* @__PURE__ */ Oe("true,false,null,this"), Na = (t, s) => {
  if (t.type === 5)
    t.content = Ce(
      t.content,
      s
...
` : ""} ? ${O}${P}.value${R} : ${O}${P}${R}`;
  ...
  if (m === !1)
    return t;
  if (m === null || !m && pt(p)) {
    const P = s.identifiers[p], y = mc(p), C = pm(p);
...
const mh = /* @__PURE__ */ new WeakMap(), yh = (t, s) => function() {
  ...
  if (t.children.length > 0)
    ...
    l !== Ds) {
      ...
      m = t.children;
  g && g.length && (b = Em(g)), t.codegenNode = hs(
    s,
    l,
    p,
    m,
...
function Gu(t) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    l ? (c === "style" || c === "class" || hc(c)) && Sm(l, u) : (s.set(c, u), r.push(u));
  }
  return r;
}
function Sm(t, s) {
...
}, Ku = /* @__PURE__ */ new WeakSet(), Am = (t, s) => {
...
const Ju = /* @__PURE__ */ new WeakSet(), wm = (t, s) => {
  if (t.type === 1) {
    const r = Ee(t, "memo");
...
const Im = {
...
}, km = /* @__PURE__ */ Oe("passive,once,capture"), Lm = /* @__PURE__ */ Oe(
  // event propagation management
  "stop,prevent,self,ctrl,shift,alt,meta,exact,middle"
), Mm = /* @__PURE__ */ Oe("left,right"), bh = /* @__PURE__ */ Oe("onkeyup,onkeydown,onkeypress"), Rm = (t, s, r, o) => {
  const u = [], c = [], l = [];
  for (let h = 0; h < s.length; h++) {
    const p = s[h].content;
    km(p) ? l.push(p) : Mm(p) ? _e(t) ? bh(t.content.toLowerCase()) ? u.push(p) : c.push(p) : (u.push(p), c.push(p)) : Lm(p) ? c.push(p) : u.push(p);
  }
  return {
    keyModifiers: u,
    nonKeyModifiers: c,
  ...
  t,
  ")"
]) : t, Dm = (t, s, r) => di(t, s, r, (o) => {
  const { modifiers: u } = t;
  if (!u.length) return o;
  let { key: c, value: l } = o.props[0];
  const { keyModifiers: h, nonKeyModifiers: p, eventOptionModifiers: m } = Rm(c, u, r, t.loc);
...
const Um = /__VUE_EXP_START__(.*?)__VUE_EXP_END__/g, $m = (t, s, r) => {
  if (s.scopes.vSlot > 0)
    return;
...
}, jm = /^(data|aria)-/, Qu = (t, s) => (s === 0 ? Bd(t) : s === 1 ? Ud(t) : s === 2 ? $d(t) : !1) || jm.test(t), qm = /* @__PURE__ */ Oe(
  "caption,thead,tr,th,tbody,td,tfoot,colgroup,col"
);
function Hm(t) {
  if (t.type === 1 && qm(t.tag))
    return !1;
  if (t.type === 12)
    return [1, 0];
    ...
    if (c.type === 6)
      ...
      if (c.name === "bind") {
        ...
        if (h != null) {
          ...
          p === "class" ? h = xc(h) : p === "style" && (h = vd(gc(h))), r += ` ${c.arg.content}="${Ze(
            h
          )}"`;
        }
...
const ts = /* @__PURE__ */ new Set(["h1", "h2", "h3", "h4", "h5", "h6"]), Lt = /* @__PURE__ */ new Set([]), Zu = {
  ...
  if (t.type === 1 && t.tagType === 0 && s.parent && s.parent.type === 1 && s.parent.tagType === 0 && !Wm(s.parent.tag, t.tag)) {
...
var Qm = /* @__PURE__ */ Ym(), Zm = /* @__PURE__ */ Dc(Qm);
...
function t1(t, s, r, o = !1) {
  return r ? Zm(t + s) : `${t}-${qd(s, o)}`;
}
...
var n1 = "browser", a1 = "browser", o1 = !0, u1 = {}, l1 = [], c1 = "", h1 = {}, p1 = {}, f1 = {};
function Wt() {
}
var d1 = Wt, m1 = Wt, y1 = Wt, g1 = Wt, b1 = Wt, x1 = Wt, S1 = Wt;
function E1(t) {
...
var ss = zt.performance || {}, w1 = ss.now || ss.mozNow || ss.msNow || ss.oNow || ss.webkitNow || function() {
  return (/* @__PURE__ */ new Date()).getTime();
};
function v1(t) {
  var s = w1.call(ss) * 1e-3, r = Math.floor(s), o = Math.floor(s % 1 * 1e9);
  return t && (r = r - t[0], o = o - t[1], o < 0 && (r--, o += 1e9)), [r, o];
}
var C1 = /* @__PURE__ */ new Date();
function I1() {
  var t = /* @__PURE__ */ new Date(), s = t - C1;
  return s / 1e3;
}
var wt = {
  nextTick: i1,
...
var N1 = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/, Ya = function(t) {
  return N1.exec(t).slice(1);
};
function Fr() {
...
var _1 = "ab".substr(-1) === "b" ? function(t, s, r) {
  return t.substr(s, r);
} : function(t, s, r) {
...
var Zi = 2147483647, Rs = 36, Lh = 1, Kn = 26, k1 = 38, L1 = 700, M1 = 72, R1 = 128, D1 = "-", F1 = /[^\x20-\x7E]/, B1 = /[\x2E\u3002\uFF0E\uFF61]/g, U1 = {
  overflow: "Overflow: input needs wider integers to process",
  "not-basic": "Illegal input >= 0x80 (not a basic code point)",
  "invalid-input": "Invalid input"
}, en = Rs - Lh, rs = Math.floor, tn = String.fromCharCode;
function nl(t) {
  throw new RangeError(U1[t]);
}
function $1(t, s) {
...
function V1(t, s) {
  var r = t.split("@"), o = "";
  r.length > 1 && (o = r[0] + "@", t = r[1]), t = t.replace(B1, ".");
  var u = t.split("."), c = $1(u, s).join(".");
  return o + c;
}
function j1(t) {
...
function q1(t, s, r) {
  var o = 0;
  for (t = r ? rs(t / L1) : t >> 1, t += rs(t / s); t > en * Kn >> 1; o += Rs)
    t = rs(t / en);
  return rs(o + (en + 1) * t / (t + k1));
}
function H1(t) {
  var s, r, o, u, c, l, h, p, m, d, b, g = [], x, T, P, y;
  for (t = j1(t), x = t.length, s = R1, r = 0, c = M1, l = 0; l < x; ++l)
    b = t[l], b < 128 && g.push(tn(b));
  for (o = u = g.length, u && g.push(D1); o < x; ) {
    for (h = Zi, l = 0; l < x; ++l)
      b = t[l], b >= s && b < h && (h = b);
    for (T = o + 1, h - s > rs((Zi - r) / T) && nl("overflow"), r += (h - s) * T, s = h, l = 0; l < x; ++l)
      if (b = t[l], b < s && ++r > Zi && nl("overflow"), b == s) {
        ...
        g.push(tn(al(p, 0))), c = q1(r, T, o == u), r = 0, ++o;
      }
    ++r, ++s;
  }
  return g.join("");
...
function z1(t) {
  return V1(t, function(s) {
    return F1.test(s) ? "xn--" + H1(s) : s;
  });
}
var Qe = [], We = [], X1 = typeof Uint8Array < "u" ? Uint8Array : Array, to = !1;
function Mh() {
  to = !0;
...
function W1(t) {
  ...
  c = t[h - 2] === "=" ? 2 : t[h - 1] === "=" ? 1 : 0, l = new X1(h * 3 / 4 - c), o = c > 0 ? h - 4 : h;
  var p = 0;
...
function K1(t, s, r) {
  for (var o, u = [], c = s; c < r; c += 3)
    o = (t[c] << 16) + (t[c + 1] << 8) + t[c + 2], u.push(G1(o));
  return u.join("");
}
function ol(t) {
  to || Mh();
  for (var s, r = t.length, o = r % 3, u = "", c = [], l = 16383, h = 0, p = r - o; h < p; h += l)
    c.push(K1(t, h, h + l > p ? p : h + l));
...
var J1 = {}.toString, Dh = Array.isArray || function(t) {
  return J1.call(t) == "[object Array]";
};
/*!
...
function Fh(t, s, r, o) {
  ...
  return typeof ArrayBuffer < "u" && s instanceof ArrayBuffer ? ey(t, s, r, o) : typeof s == "string" ? Z1(t, s, r) : ty(t, s);
}
...
function ty(t, s) {
  ...
  if (s) {
    if (typeof ArrayBuffer < "u" && s.buffer instanceof ArrayBuffer || "length" in s)
      return typeof s.length != "number" || Sy(s.length) ? ut(t, 0) : Jn(t, s);
...
V.prototype.toString = function() {
  var s = this.length | 0;
  return s === 0 ? "" : arguments.length === 0 ? jh(this, 0, s) : sy.apply(this, arguments);
};
...
function oy(t, s, r, o) {
  return Si(xy(s, t.length - r), t, r, o);
}
...
var dy = /[^+\/0-9A-Za-z-_]/g;
function my(t) {
  if (t = yy(t).replace(dy, ""), t.length < 2) return "";
  for (; t.length % 4 !== 0; )
    t = t + "=";
  return t;
}
...
function Ey(t) {
  return t != null && (!!t._isBuffer || Wh(t) || Py(t));
}
function Wh(t) {
...
var Ty = Object.getOwnPropertyDescriptors || function(s) {
...
function os(t, s) {
  ...
  return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), Gh(s) ? r.showHidden = s : s && Ly(r, s), ns(r.showHidden) && (r.showHidden = !1), ns(r.depth) && (r.depth = 2), ns(r.colors) && (r.colors = !1), ns(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = Ay), $r(r, t, r.depth);
}
os.colors = {
  bold: [1, 22],
  italic: [3, 23],
...
function $r(t, s, r) {
  ...
  t.seen.push(s);
  var g;
  return m ? g = Iy(t, s, r, l, c) : g = c.map(function(x) {
...
function Dy(t, s, r, o) {
  return s = s || "&", r = r || "=", t === null && (t = void 0), typeof t == "object" ? hl(Fy(t), function(u) {
...
function pl(t, s, r, o) {
  ...
  for (var p = 0; p < h; ++p) {
    ...
    d >= 0 ? (b = m.substr(0, d), g = m.substr(d + 1)) : (b = m, g = ""), x = decodeURIComponent(b), T = decodeURIComponent(g), Ry(u, x) ? Jh(u[x]) ? u[x].push(T) : u[x] = [u[x], T] : u[x] = T;
  }
  return u;
}
...
var Uy = /^([a-z0-9.+-]+:)/i, $y = /:[0-9]*$/, Vy = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, jy = ["<", ">", '"', "`", " ", "\r", `
`, "	"], qy = ["{", "}", "|", "\\", "^", "`"].concat(jy), Qn = ["'"].concat(qy), fl = ["%", "/", "?", ";", "#"].concat(Qn), dl = ["/", "?", "#"], Hy = 255, ml = /^[+a-z0-9A-Z_-]{0,63}$/, zy = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, Xy = {
  javascript: !0,
  "javascript:": !0
}, Zn = {
  javascript: !0,
...
function Zh(t, s, r, o) {
  ...
  if (!Zn[d] && (g || d && !us[d])) {
    ...
    if (!F) {
      ...
      for (x = 0, P = M.length; x < P; x++) {
        ...
        if (D && !D.match(ml)) {
          ...
          if (!U.match(ml)) {
            var O = M.slice(0, x), R = M.slice(x + 1), j = D.match(zy);
    ...
    t.hostname.length > Hy ? t.hostname = "" : t.hostname = t.hostname.toLowerCase(), F || (t.hostname = z1(t.hostname)), y = t.port ? ":" + t.port : "";
    var W = t.hostname || "";
...
function no(t) {
  ...
  t.host ? c = s + t.host : t.hostname && (c = s + (t.hostname.indexOf(":") === -1 ? t.hostname : "[" + this.hostname + "]"), t.port && (c += ":" + t.port)), t.query && Es(t.query) && Object.keys(t.query).length && (l = Dy(t.query));
  var h = t.search || l && "?" + l || "";
...
var Qy = Object.defineProperty, Zy = Object.defineProperties, eg = Object.getOwnPropertyDescriptors, yl = Object.getOwnPropertySymbols, tg = Object.prototype.hasOwnProperty, sg = Object.prototype.propertyIsEnumerable, gl = (t, s, r) => s in t ? Qy(t, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[s] = r, un = (t, s) => {
  for (var r in s || (s = {}))
    tg.call(s, r) && gl(t, r, s[r]);
  if (yl)
    for (var r of yl(s))
      sg.call(s, r) && gl(t, r, s[r]);
  return t;
}, rg = (t, s) => Zy(t, eg(s));
const zs = {
  base: null,
...
}, ig = (t) => Object.keys(t).some((s) => Ae(t[s])) ? rg(un({}, zs), {
  tags: t
}) : un(un({}, zs), t), ng = (t) => (s, r) => op(s, r, t), op = (t, s, r = zs) => {
  if (t.type === 1) {
    if (!t.props.length)
      return;
    ...
    t.props.forEach((h, p) => {
      ...
      const d = ag(m.path, m.hash, h.loc, s);
      t.props[p] = {
        type: 7,
        name: "bind",
...
const og = ["img", "source"], ug = /( |\\t|\\n|\\f|\\r)+/g, lg = (t) => (s, r) => up(s, r, t), up = (t, s, r = zs) => {
  t.type === 1 && og.includes(t.tag) && t.props.length && t.props.forEach((o, u) => {
    if (o.name === "srcset" && o.type === 6) {
      if (!o.value) return;
      const c = o.value.content;
      if (!c) return;
      const l = c.split(",").map((d) => {
        const [b, g] = d.replace(ug, " ").trim().split(" ", 2);
...
const ks = /* @__PURE__ */ new WeakMap(), Sg = (t, s) => {
  if (!(t.type !== 1 || t.tagType !== 0))
    return function() {
                ...
                for (let y = 0; y < T.length; y++) {
                  ...
                  if (_e(C)) {
                    ...
                    L === "class" ? o.push(
                      ...
                      '"'
                    ) : (L = t.tag.indexOf("-") > 0 ? L : Fd[L] || L.toLowerCase(), Ec(L) ? o.push(
                      Ge(
                        Q(
                          s.helper(oo),
                          [N]
      ...
      p && m && (xl(p, m), Tg(o, "class")), s.scopeId && o.push(` ${s.scopeId}`), t.ssrCodegenNode = ma(o);
    };
};
function uo(t, s, r) {
  let o = [];
...
var _g = Object.defineProperty, Og = Object.defineProperties, kg = Object.getOwnPropertyDescriptors, Sl = Object.getOwnPropertySymbols, Lg = Object.prototype.hasOwnProperty, Mg = Object.prototype.propertyIsEnumerable, El = (t, s, r) => s in t ? _g(t, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[s] = r, Vt = (t, s) => {
  for (var r in s || (s = {}))
    Lg.call(s, r) && El(t, r, s[r]);
  if (Sl)
    for (var r of Sl(s))
      Mg.call(s, r) && El(t, r, s[r]);
  return t;
}, Rg = (t, s) => Og(t, kg(s));
const vp = /* @__PURE__ */ new WeakMap(), Cp = Symbol(), Ip = /* @__PURE__ */ new WeakMap(), Dg = (t, s) => {
  ...
  if (Ip.set(t, r), vt(r))
    return r === ds ? bg(t, s) : r === Ss ? vg(t, s) : r === Xt ? Ig(t) : void 0;
  const u = [], c = ia(t);
  return function() {
...
const Np = /* @__PURE__ */ new WeakMap(), [Bg, Ug] = Ba(!0), $g = [...Bg, ...Ka], Vg = Vt(Vt({}, Ug), Ja);
function jg(t, s, r, o) {
  const u = Np.get(o.root), c = Rg(Vt({}, u), {
    // overwrite with vnode-based transforms
    nodeTransforms: [
      ...$g,
      ...u.nodeTransforms || []
    ],
    directiveTransforms: Vt(Vt({}, Vg), u.directiveTransforms || {})
  }), l = [];
  return t && l.push({
    type: 7,
    name: "slot",
...
function zg(t, s = t.withSlotScopeId) {
  return _p(
    t.root,
    t.options,
    t.helpers,
...
const Wg = (t, s, r) => (t.exp || r.onError(
  Me(61)
), {
  props: [
    le(
...
}), na = (t) => t.children.filter((s) => s.type !== 3), ln = (t) => na(t).length === 1, Gg = (t, s) => {
...
var Jg = Object.defineProperty, Yg = Object.defineProperties, Qg = Object.getOwnPropertyDescriptors, Tl = Object.getOwnPropertySymbols, Zg = Object.prototype.hasOwnProperty, e2 = Object.prototype.propertyIsEnumerable, Al = (t, s, r) => s in t ? Jg(t, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[s] = r, gr = (t, s) => {
  for (var r in s || (s = {}))
    Zg.call(s, r) && Al(t, r, s[r]);
  if (Tl)
    for (var r of Tl(s))
      e2.call(s, r) && Al(t, r, s[r]);
  return t;
}, wl = (t, s) => Yg(t, Qg(s));
function t2(t, s = {}) {
  s = wl(gr(gr({}, s), yi), {
...
var s2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  compile: t2
}), r2 = {}, i2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: r2
}), n2 = /* @__PURE__ */ ba(i2), lo = /* @__PURE__ */ ba(O1);
const vl = {};
function Cl(t) {
  !(typeof process < "u" && process.env.NODE_ENV === "production") && !vl[t] && (vl[t] = !0, a2(t));
}
function a2(t) {
  console.warn(
...
var o2 = Object.defineProperty, u2 = Object.defineProperties, l2 = Object.getOwnPropertyDescriptors, Il = Object.getOwnPropertySymbols, c2 = Object.prototype.hasOwnProperty, h2 = Object.prototype.propertyIsEnumerable, Nl = (t, s, r) => s in t ? o2(t, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[s] = r, qr = (t, s) => {
  for (var r in s || (s = {}))
    c2.call(s, r) && Nl(t, r, s[r]);
  if (Il)
    for (var r of Il(s))
      h2.call(s, r) && Nl(t, r, s[r]);
  return t;
}, aa = (t, s) => u2(t, l2(s));
function p2({ source: t, filename: s, preprocessOptions: r }, o) {
  let u = "", c = null;
  if (o.render(
    t,
    qr({ filename: s }, r),
...
function _l({
  ...
  const y = s.replace(/^data-v-/, ""), C = `data-v-${y}`, N = h ? s2 : rl;
  ...
  let { code: L, ast: F, preamble: M, map: D } = d.compile(l || c, aa(qr({
    ...
    hoistStatic: !0,
    cacheHandlers: !0,
    ssrCssVars: h && p && p.length ? e1(p, y, m, !0) : "",
    scopeId: r ? C : void 0,
    slotted: o,
    sourceMap: !0
  }, b), {
  ...
  u && !l && (D && (D = d2(u, D)), x.length && m2(x, c, u));
  const U = T.map((v) => {
    let I = v.message;
    return v.loc && (I += `
${yc(
...
var Rp = /* @__PURE__ */ ba(Gy), Tn, zl;
function Dp() {
  if (zl) return Tn;
  zl = 1;
  let { existsSync: t, readFileSync: s } = n2, { dirname: r, join: o } = lo, { SourceMapConsumer: u, SourceMapGenerator: c } = /* @__PURE__ */ li();
  function l(p) {
...
function wi() {
  if (Xl) return An;
  Xl = 1;
  let { nanoid: t } = /* @__PURE__ */ y2(), { isAbsolute: s, resolve: r } = lo, { SourceMapConsumer: o, SourceMapGenerator: u } = /* @__PURE__ */ li(), { fileURLToPath: c, pathToFileURL: l } = Rp, h = /* @__PURE__ */ co(), p = /* @__PURE__ */ Dp(), m = /* @__PURE__ */ Lp(), d = Symbol("fromOffsetCache"), b = !!(o && u), g = !!(r && s);
  class x {
    get from() {
...
function yo() {
  if (Zl) return On;
  Zl = 1;
  let t = /* @__PURE__ */ Gt(), s = /* @__PURE__ */ wi(), r = /* @__PURE__ */ b2();
  function o(u, c) {
...
function S2() {
  if (nc) return Fn;
  nc = 1;
  let t = /* @__PURE__ */ fo(), s = /* @__PURE__ */ Vp(), r = /* @__PURE__ */ x2(), o = /* @__PURE__ */ sr();
  class u {
    constructor(l = []) {
...
function E2() {
  if (ac) return Bn;
  ac = 1;
  let t = /* @__PURE__ */ po(), s = /* @__PURE__ */ Ti(), r = /* @__PURE__ */ Gt(), o = /* @__PURE__ */ co(), u = /* @__PURE__ */ Ai(), c = /* @__PURE__ */ fo(), l = /* @__PURE__ */ g2(), h = /* @__PURE__ */ wi(), p = /* @__PURE__ */ Vp(), m = /* @__PURE__ */ Fp(), d = /* @__PURE__ */ Pi(), b = /* @__PURE__ */ yo(), g = /* @__PURE__ */ S2(), x = /* @__PURE__ */ go(), T = /* @__PURE__ */ sr(), P = /* @__PURE__ */ mo(), y = /* @__PURE__ */ Ei(), C = /* @__PURE__ */ Up();
  function N(...L) {
...
var P2 = /* @__PURE__ */ E2(), ge = /* @__PURE__ */ Dc(P2);
ge.stringify;
ge.fromJSON;
ge.plugin;
ge.parse;
...
(ft.posix || ft).join;
const oc = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", T2 = new Uint8Array(64), A2 = new Uint8Array(128);
for (let t = 0; t < oc.length; t++) {
  const s = oc.charCodeAt(t);
  T2[t] = s, A2[s] = t;
}
var w2 = Object.defineProperty, uc = Object.getOwnPropertySymbols, v2 = Object.prototype.hasOwnProperty, C2 = Object.prototype.propertyIsEnumerable, lc = (t, s, r) => s in t ? w2(t, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[s] = r, cc = (t, s) => {
  for (var r in s || (s = {}))
    v2.call(s, r) && lc(t, r, s[r]);
  if (uc)
    for (var r of uc(s))
      C2.call(s, r) && lc(t, r, s[r]);
  return t;
};
cc(cc({}, ga), Wa);
Ut.parse;
const jp = {}, I2 = od("./src/iconfont/*/iconfont.js", { eager: !0, as: "raw" });
I2.forEach((t) => {
  const r = ud(t).toString().match(/<symbol[^>]*>.*?<\/symbol>/gim);
  Array.isArray(r) && r.length && r.forEach((o) => {
    const u = o.replace(/.*id="([^"]+)".*/, "$1").replace(/(^|-|_)(\w)/g, (l, h, p) => p.toUpperCase()), c = "virtual:" + u + ".svg";
    jp[u] = {
      id: u,
      virtualModuleId: c,
      code: o.replace(/(.*?)id="[^"]+"(.*?)/, '$1id="' + u + '"$2').replaceAll("symbol", "svg"),
      resolvedVirtualModuleId: "\0virtual:" + u
    };
  });
});
function B2() {
  const t = Object.values(jp), s = "virtual:icon-import", r = "\0" + s;
  return {
    name: "icon-import-plugin",
    resolveId(o) {
      const u = t.find((c) => c.virtualModuleId === o);
      if (u)
        return u.resolvedVirtualModuleId;
      if (o === s)
        return r;
    },
    load(o) {
      const u = t.find((c) => c.resolvedVirtualModuleId === o);
      if (u) {
        let c = ld(u.code).data;
        c = c.replace(/<style/g, '<component is="style"').replace(/<\/style/g, "</component").replace(/<svg/g, '<svg class="iconfont" width="1em" height="1em" fill="currentColor" color="currentColor"');
        const { code: l } = f2({
          id: JSON.stringify(o),
          source: c,
          filename: u.id + ".svg",
...
export default { render: render }`;
        ...
        const c = [], l = [];
        return t.forEach(({ id: h, virtualModuleId: p }) => {
          c.push(`import ${h} from '${p}'`), l.push(h);
        }), [c.join(`
`), "export {", l.join(`,
`), "}"].join(`
`);
